...
Lock your PDF behind a password so only authorized people can open it. AEV-PDF uses 256-bit AES encryption -- the same standard used by banks and government agencies -- applied entirely in your browser via QPDF.
...
The owner password controls what an authorized user can do after opening the file. When you set a distinct owner password, AEV-PDF automatically applies the strictest restriction set:
