...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/alam00000/AEV-PDF)

## Manual Deployment

### Step 1: Fork the Repository

Fork [AEV-PDF/AEV-PDF](https://github.com/alam00000/AEV-PDF) to your GitHub account.
...
| `VITE_BRAND_NAME`       | Custom brand name (replaces "AEV-PDF")                      |
...
::: warning Large Files
Vercel's serverless functions have a 50MB limit. Since AEV-PDF is a static site, this shouldn't affect you, but WASM modules are large (~100MB total). Ensure they're served from the `/public` folder.
:::
